...
$GLOBALS['TL_DCA']['tl_page']['palettes']['news_reader'] = '{title_legend},title,type;{routing_legend},alias,redirectParameters,routePath,routePriority,routeParameters,routeConflicts;{archives_legend},newsArchives;{image_legend},imgSize;{cache_legend:hide},includeCache;{expert_legend:hide},cssClass,sitemap,hide,noSearch;{publish_legend},published,start,stop';
